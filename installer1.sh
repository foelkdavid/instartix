...
basestrap /mnt base linux linux-firmware syslinux sudo iwd nano dhcpcd grub git man binutils make gcc pkg-config fakeroot patch neovim neofetch memtest86+ edk2-shell openrc &&
echo "done." &&
...
echo "creatubg instartix folder" &&
